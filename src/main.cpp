...
int main()
{
	cout << "\n*******************START*******************\n\nWelcome to Elementary Graph Algorithms' Application" << endl;
	Graph G1;
	...
	while (mod_flag!= -1)
	{
		...
		switch(mod_flag)
		{
			case 1:
			{
				...
				while(f1!=-1)
				{
					...
					switch(f1)
					{
						...
						case -1:
							cout << "No module selected, Exiting.\n" << endl;
						break;
					...
					switch(f4)
					{
						case 1:
							if(Test_bipartite(G1))
								cout << "The graph entered is bipartite\n" << endl;
							else
								cout << "The graph entered is not bipartite\n" << endl;
						break;
			...
			default:
			cout << "No such module exists. Enter again.\n" << endl;
			break;
		}
	}
